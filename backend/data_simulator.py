...
def get_predictions():
    return simulator.get_predictions()

def get_historical_data():
    return simulator.get_historical_data()
...
if __name__ == '__main__':
    ...
    print(f"Predictions: {len(get_predictions())}")
    print(f"Historical data points: {len(get_historical_data())}")